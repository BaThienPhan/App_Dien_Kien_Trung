...
if page == "Vị trí":
    ...
    with col1:
        st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/vi-tri-1.jpg",
                 caption="Điện Kiến Trung thời Pháp", use_column_width=True)
    with col2:
        st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/vi-tri-2.jpg",
    ...
    """, unsafe_allow_html=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/ls-phong-choi-bia.jpg",
    ...
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/ls-do-ma-khai-dinh.jpg",
    ...
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/ls-di-tich-con-lai.jpg",
    ...
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/Sau-phuc-dung-1.jpg",
    ...
    """, unsafe_allow_html=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/tt-dien-kien-dang-khoi-phuc-1.jpg",
    ...
    """, unsafe_allow_html=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/tt-dien-kien-trung-dang-thi-cong-2.jpg",
             caption="Hình ảnh 1", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/Sau-phuc-dung-2.jpg",
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/Sau-phuc-dung-hoa-tiet-4.jpg",
                 caption="", use_column_width=True)
    with col2:
        st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/Sau-phuc-dung-hoa-tiet-5.jpg",
                 caption="", use_column_width=True)
    st.markdown("""
    <div class='text'>
    ...
    """, unsafe_allow_html=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/Sau-phuc-dung-3.jpg",
    ...
    """, unsafe_allow_html=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/du-khach-1.jpg",
             caption="Hình ảnh du khách khá vui vẻ khi thăm quan.", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/du-khach-1-1.jpg",
             caption="", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/du-khach-2.jpg",
             caption="", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/du-khach-3.jpg",
             caption="", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/du-khach-4.jpg",
             caption="", use_column_width=True)
    st.markdown("""
    ...
    """, unsafe_allow_html=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/festival-dien-kien-trung-1.jpg",
             caption="", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/festival-dien-kien-trung-2.jpg",
             caption="", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/festival-dien-kien-trung-3.jpg",
             caption="", use_column_width=True)
    st.image("C:/Users/bathi/OneDrive/Desktop/Python/DienKienTrung/festival-dien-kien-trung-4.jpg",
             caption="", use_column_width=True)
elif page == "Liên hệ":
