...
if page == "Vị trí":
    ...
    with col1:
        st.image(load_image("https://github.com/BaThienPhan/App_Dien_Kien_Trung/main/vi-tri-1.jpg"),
                 caption="Điện Kiến Trung thời Pháp", use_column_width=True)
    with col2:
        st.image(load_image("https://github.com/BaThienPhan/App_Dien_Kien_Trung/main/vi-tri-2.jpg"),
